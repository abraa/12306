...
urls = {
    ...
    "select_url": {
        # "req_url": "/otn/leftTicket/queryZ?leftTicketDTO.train_date={0}&leftTicketDTO.from_station={1}&leftTicketDTO.to_station={2}&purpose_codes=ADULT",   // queryZ换成了queryA 12306接口改了
